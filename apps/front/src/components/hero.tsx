...
export default function Hero() {
    return (
        <div className="bg-gradient-to-br from-sky-500 to-sky-500 to indigo-500 text-white pt-12">
            <div className="container mx-auto flex flex-col md:flex-row items-center flex-wrap px-3">
                ...
                <div className="flex flex-col w-full justify-center items-start md:w-2/5 text-center md:text-left">
                    ...
                    <h2 className="my-5 text-5xl font-bold leading-tight">Welcome to Stark Introduction</h2>
                    <p className="leading-normal text-xl">Join a comunity that thrives on learning, creating, and growing together. {" "}</p>
                </div>
                {/* right col */}
